...
static enum vreg_lp_id	sdslot_vreg;
static enum vreg_lp_id	wlan_vreg_1;
static enum vreg_lp_id	wlan_vreg_2;
...
static uint32_t wifi_off_gpio_table[] =
{
	...
	PCOM_GPIO_CFG(152, 0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_4MA),  /* WLAN IRQ */
};
...
//	gpio_set_value(HTCLEO_GPIO_WIFI_SHUTDOWN_N, 0);
	...
	sdslot_vreg = PM_VREG_LP_GP6_ID;
	wlan_vreg_1 = PM_VREG_LP_WLAN_ID;
	wlan_vreg_2 = PM_VREG_LP_MSME1_ID;
//	wlan_vreg_3 = PM_VREG_LP_RFTX_ID;
